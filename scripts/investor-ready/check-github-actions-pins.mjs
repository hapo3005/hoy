...
const summary={
  ...
  remote_uses_records:inventory.length,
  immutable_records:inventory.filter(x=>x.immutable).length,
  floating_records:findings.length,
  status:findings.length?'REVIEW_REQUIRED':'GREEN',
  findings,
  inventory
};
