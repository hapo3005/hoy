...
for (const required of [
  'document_sha256','spanish_document_sha256','legal_entity_name','registered_address','legal_contact_email',
  'privacy_notice_version','governing_law','jurisdiction','counsel_reviewed_at','counsel_reference'
]) {
