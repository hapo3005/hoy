...
async function ready(page){
  ...
  await page.waitForFunction(()=>Array.isArray(DATA)&&DATA.length>0&&window.hoyMenuSourceTruthVersion==='2.34.0'&&window.hoyMenuSourceTruth234&&cloud.status==='online',{timeout:30000});
}

test('HOY 2.34 menu-source truth assets are wired and cached',async({request})=>{
