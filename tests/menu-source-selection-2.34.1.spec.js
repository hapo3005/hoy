...
test('active official source selection excludes stale states and prefers completeness',async({request})=>{
  ...
  expect(js).toContain('statusWeight234(b)-statusWeight234(a)||scopeWeight234(b)-scopeWeight234(a)');
});
