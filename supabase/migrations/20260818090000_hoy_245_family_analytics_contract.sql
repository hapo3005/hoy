-- HOY 2.45 — keep the anonymous analytics RPC fail-closed while adding the two
-- Family events introduced by the 2.40 decision layer.
--
...
begin
  if p_event_type is null or p_event_type not in (
    ...
    'family_filter','family_situation_open'
  ) then
