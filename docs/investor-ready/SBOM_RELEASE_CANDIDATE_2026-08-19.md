...
This inventory combines the deterministic npm QA graph now merged by PR #112 with the direct runtime pins already merged by PR #111 and the main browser runtime dependencies previously classified in RT-006.
...
PR #112 is merged to `main` at `ff4f3f8075b25cf8833c32821837d2bd72a6a153` and pins all external GitHub Actions references to immutable 40-character SHAs. Current approved map:
- `actions/checkout` v6 → `d23441a48e516b6c34aea4fa41551a30e30af803`
- `actions/setup-node` v6 → `249970729cb0ef3589644e2896645e5dc5ba9c38`
- `actions/upload-artifact` v5 → `330a01c490aca151604b8cf639adc76d48f6c5d4`

The RT-006 verifier counted 30 external `uses:` entries and fails closed on a mutable external Action ref.
...
After the privacy candidate is resolved and the release commit is frozen:
...
The dependency graph is materially reproducible, RT-006 is merged, and direct runtime pins are in place. Final GREEN requires the final merged release SHA plus machine SBOM/licence reconciliation.
